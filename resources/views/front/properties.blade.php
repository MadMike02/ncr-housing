									...
									<div class="property-listing property-1">
										...
										<div class="listing-img-wrapper">
											<a href="single-property-2.html">
												<img src="{{asset('assets/site/img/p-1.jpg')}}" class="img-fluid mx-auto" alt="" />
											</a>
										...
										<div class="listing-content">
											...
											<div class="listing-detail-wrapper">
												...
												<div class="list-author">
													<a href="#"><img src="{{asset('assets/site/img/user-3.jpg')}}" class="img-fluid img-circle avater-30" alt=""></a>
												</div>
											</div>
							...
							<div class="simple-sidebar sm-sidebar" id="filter_search"  style="left:0;">							
								...
								<div class="sidebar-widgets">
									...
									<div class="range-slider">
										...
										<div data-min="0" data-max="50000" data-min-name="min_price" data-max-name="max_price" data-unit="INR" class="range-slider-ui ui-slider" aria-disabled="false"></div>
  ...
  crossorigin=""></script>
		...
		<script type="text/javascript">
			...
			L.marker([28.53, 77.39]).addTo(map)
			    .bindPopup('<b>PROPERTY 1</b></br>PRICE: 25L<br><a href="">READ MORE</a>');

			 L.marker([28.66, 77.45]).addTo(map)
			    .bindPopup('<b>PROPERTY 2</b></br>PRICE: 45L<br><a href="">READ MORE</a>');

			  L.marker([28.45, 77.02]).addTo(map)
			    .bindPopup('<b>PROPERTY 3</b></br>PRICE: 75L<br><a href="">READ MORE</a>');

			   L.marker([28.876392013964153, 76.90268186265428]).addTo(map)
			    .bindPopup('<b>PROPERTY $</b></br>PRICE: 75L<br><a href="">READ MORE</a>');
